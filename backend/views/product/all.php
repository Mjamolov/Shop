...
<div>
    <a class="btn btn-warning" href="/php/Shop(stream13)/backend/index.php?model=product&action=create"> Добавить товар</a>
</div>
    ...
    <?php foreach ($all as $product) : ?>
        <tr>
            ...
            <td style="width: 200px">
                <a href="/php/Shop(stream13)/backend/index.php?model=product&action=delete&id=<?= $product["id"] ?>" class="btn btn-danger">Delete</a>
