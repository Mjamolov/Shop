        ...
        <section class="content">
            <div class="card card-info">
                ...
                <form class="form-horizontal"
                      action="/php/Shop(stream13)/backend/index.php?model=order&action=update"
                      method="post"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="<?= $one['name'] ?? '' ?>" name="name" lass="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Phone</label>
                            <div class="col-sm-10">
                                <input type="text" value="<?= $one['phone'] ?? '' ?>" name="phone"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="<?= $one['email'] ?? '' ?>" name="email"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
